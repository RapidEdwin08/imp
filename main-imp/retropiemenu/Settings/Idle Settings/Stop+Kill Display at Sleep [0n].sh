...
sudo chmod 755 /opt/retropie/configs/all/emulationstation/scripts/sleep/impXdisplay0.sh

cat /opt/retropie/configs/imp/impXdisplay1.sh > /opt/retropie/configs/all/emulationstation/scripts/wake/impXdisplay1.sh
sudo chmod 755 /opt/retropie/configs/all/emulationstation/scripts/wake/impXdisplay1.sh
